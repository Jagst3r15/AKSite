...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    // modernizr (without media query polyfill)
    wp_register_script( 'tiny-carousel', get_stylesheet_directory_uri() . '/library/carousel/js/jquery.tinycarousel.min.js', array(), '2.5.3', false );
    ...
    if(is_post_type_archive('looks')) {
	    wp_enqueue_script('tiny-carousel');
	}
    /*
