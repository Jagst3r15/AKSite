...
function custom_post_example() { 
	...
	register_post_type( 'looks', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Looks', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('Looks', 'bonestheme'), /* This is the individual type */
			'all_items' => __('All Looks', 'bonestheme'), /* the all items menu item */
			'add_new' => __('Add New', 'bonestheme'), /* The add new menu item */
			'add_new_item' => __('Add New Look', 'bonestheme'), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __('Edit Looks', 'bonestheme'), /* Edit Display Title */
			'new_item' => __('New Look', 'bonestheme'), /* New Display Title */
			'view_item' => __('View Looks', 'bonestheme'), /* View Display Title */
			'search_items' => __('Search Looks', 'bonestheme'), /* Search Custom Type Title */ 
			...
			'rewrite'	=> array( 'slug' => 'looks', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'looks', /* you can rename the slug here */
